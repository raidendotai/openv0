				  ...
				  dark:bg-[#050505] dark:text-[#fff]">
					...
					<div className="mb-52 mt-2 pt-2 grid md:grid-cols-12">
				      ...
				      <div className="text-xs ml-4 flex">
				        <a href="" onClick={() => {event.preventDefault() ; setMode('view')} }
				          className="p-1 px-2 bg-[#ddd] dark:bg-[#222] rounded opacity-50 hover:opacity-100 duration-200">
				        ...
				        <a href="" onClick={() => {event.preventDefault() ; setMode('code')} }
				          className="p-1 px-2 ml-2 bg-[#ddd] dark:bg-[#222] rounded opacity-50 hover:opacity-100 duration-200">
