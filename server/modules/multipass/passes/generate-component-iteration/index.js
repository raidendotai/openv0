  ...
  const context = [
    ...
    ...req.pipeline.stages[`component-design-context`].data,
    {
      ...
      content:
        ...
        "\n```\n\n\n" +
        `Write the full code for the new, updated ${req.query.framework} web component, which uses Tailwind classes if needed (add tailwind dark: classes too if you can), and optionally, library components and icons, based on the provided design task.\n` +
