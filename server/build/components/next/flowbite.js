...
async function build(){
  console.dir({build:`next/flowbite`})
  ...
  fs.writeFileSync( `./library/components/next/flowbite/dump.json`, JSON.stringify(db) )
  console.dir({
    build:`./build/components/next/flowbite.js`,
    dump: `./library/components/next/flowbite/dump.json`,
  })
