...
const UserCard: React.FC = () => {
    return (
        <Card className="transition-all duration-500 ease-in-out transform hover:-translate-y-1 hover:scale-110">
            <CardHeader className="flex items-start space-x-2 p-4 dark:bg-gray-800 justify-left">
            ...
            <CardContent className="py-4 px-6 dark:bg-gray-800 border-t border-gray-200 dark:text-gray-300 justify-left">
