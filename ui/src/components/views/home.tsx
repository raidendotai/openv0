  ...
  return (
    <div className={darkModeToggle ? "dark bg-black" : ""}>
      <div className="">
        ...
        <Tabs
          defaultValue="browse"
          className="max-w-8xl mx-auto px-24 pt-6 items-start"
        >
          <div
            className={
              darkModeToggle
                ? "dark bg-black text-white py-1 pb-4"
                : "py-1 pb-4"
            }
          >
            <a
              href="https://raiden.ai"
              target="_blank"
              className="opacity-50 hover:opacity-100 duration-200"
            >
              openv0 <span className="text-xs">by Raiden AI</span>
            </a>{" "}
            <a
              className="opacity-50 text-xs hover:opacity-80 duration-200"
              target="_blank"
              href="https://v0.dev"
            >
              &nbsp;/ an open source tool inspired by v0.dev, based on shadcn +
              lucide
            </a>
          </div>
